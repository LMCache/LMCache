...
#if MAX_SHARED_MEMORY_PER_THREAD - MAX_LP * 2 - 4 >= 256
    #define MAX_TOKENS_PER_THREAD 256
    #define OUTPUT_BUFFER_LENGTH_PER_THREAD 256
#else
    #define OUTPUT_BUFFER_LENGTH_PER_THREAD (MAX_SHARED_MEMORY_PER_THREAD - MAX_LP * 2 - 4)
        ...
        int32_t ntokens)
{
    ...
    __shared__ __align__(4) int32_t lengths_shared[BLOCK_SIZE];
