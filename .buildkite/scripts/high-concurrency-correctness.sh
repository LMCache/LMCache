...
# This script tests high concurrency / preemption to see if LMCache handles this case correctly
# This test REQUIRES batch invariant mode, which only works with FLASH_ATTN
...
echo "[INFO] High concurrency test using FLASH_ATTN (batch invariant mode required)"
