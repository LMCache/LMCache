...
def _write_result(
    ...
    """Write a normalized completion result used by the compare command."""
    result = {
        "text": text,
...
def _completion(args: argparse.Namespace) -> None:
    ...
    _write_result(args.output, text, elapsed, choice, response)
...
def _add_generation_args(parser: argparse.ArgumentParser) -> None:
    """Add the shared completion/chat request arguments."""
