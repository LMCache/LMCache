...
case "$TEST_NAME" in
    ...
    *)
        ...
        echo "Valid tests: lm_eval, hma_lm_eval_gemma4, vllm_bench, long_doc_qa, long_doc_qa_l2, fault_tolerance, deadlock, mp_autostart_tp2, restart_recovery, cache_stats, http_api"
        exit 1
        ;;
esac
