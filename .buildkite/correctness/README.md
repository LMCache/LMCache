...
Explanation: the way we will "pull" upstream code in this CI suite is simply to pull the latest upstream default branch
...
Inside of `.buildkite/correctness`, you will find two main entrypoints:

1. `single-mmlu-test.py`

This is for deploying a single serving engine without LMCache with "vanilla vllm". 
