...
- **Scripts**: `.buildkite/scripts/vllm-integration-tests.sh`
- **LMCache configs**: `lmcache_configs/`
- **Workload configs**: `workload_configs/`
- **Pipeline**: `comprehensive-tests.yml`
...
3. In `comprehensive-tests.yml`, under the test step’s `commands:`, add:

   ```yaml
       --configs=local_cpu.yaml,local_disk.yaml
    ```
