...
# Stub for the lmache_native C++ extension (implemented in csrc/storage_manager/).
#
...
class EngineKVFormat(Enum):
    ...
    NB_NL_TWO_BS_NH_HS: int
    NL_X_TWO_NB_BS_NH_HS: int
    NL_X_NB_TWO_BS_NH_HS: int
    NL_X_NB_BS_HS: int
    TWO_X_NL_X_NBBS_NH_HS: int
    NL_X_NBBS_ONE_HS: int
    NL_X_TWO_NB_NH_BS_HS: int
    NL_X_NB_TWO_NH_BS_HS: int
    NB_NL_TWO_NH_BS_HS: int
    TWO_X_NL_X_NB_BS_NH_HS: int
    NL_X_NB_NH_BS_TWO_HS: int
    NL_X_NB_BS_NH_TWO_HS: int
    NL_X_NB_NH_BS_CS: int
    NL_X_NB_BS_NH_CS: int
    NL_X_NB_BSV_BSS: int
