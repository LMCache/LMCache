...
class EvictHandler(OperationHandler):
    """Handler for evict operations"""
    ...
    def create_message(
        ...
        for _ in range(benchmark.config.batch_size):
            ...
            operations.append(KVOpEvent(op_type=OpType.EVICT, key=key, seq_num=seq_num))
