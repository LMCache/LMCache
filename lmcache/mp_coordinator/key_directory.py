...
See ``docs/design/mp_coordinator/key_directory.md``.
"""
...
from lmcache.mp_coordinator.blend_index import BlendIndex, BlendIndexStats
...
class KeyDirectory:
    ...
    def _create_token_binding(self, chunk_hash: bytes, entry: CacheEventEntry) -> None:
        ...
        :data:`~lmcache.mp_coordinator.api.UNKNOWN_TOKEN_OFFSET` fills
