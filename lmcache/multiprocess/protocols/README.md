...
2. **Create a new protocol file** (e.g., `monitoring.py`):
   ...
   """
   from lmcache.multiprocess.protocols.base import ProtocolDefinition, HandlerType
...
3. **Register the module** in `__init__.py`:
   ```python
   from lmcache.multiprocess.protocols import monitoring  # Import your module
