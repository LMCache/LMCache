...
# First Party
from lmcache.integration.vllm.vllm_v1_async_adapter import LMCacheConnectorV1AsyncImpl
...
class LMCacheAsyncConnectorV1Dynamic(KVConnectorBase_V1):
    def __init__(self, vllm_config: "VllmConfig", role: KVConnectorRole):
        super().__init__(vllm_config=vllm_config, role=role)
        self._lmcache_engine = LMCacheConnectorV1AsyncImpl(vllm_config, role, self)
    ...
    def get_finished_loading(self, scheduler_output: SchedulerOutput) -> dict[str, int]:
        ...
        Returns:
            ...
            for each request.
        """
        return self._lmcache_engine.get_finished_loading(scheduler_output)
