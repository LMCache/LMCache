...
def broadcast_seq_group_metadata(
    ...
    if is_driver_worker:
        ...
        return dataclasses.replace(model_input, seq_group_metadata_list=seq_group_metadata_list) # type: ignore[arg-type]
        ...
        for seqid, seq_data in seq_group_metadata.seq_data.items():
            ...
            if skip_leading_tokens < seq_len:
                ...
                if len(slot_mapping) > 0:
                    # TODO(Jiayi): need to write mem kernels for turing architcture
                    """
