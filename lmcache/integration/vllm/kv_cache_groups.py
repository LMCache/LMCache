...
def create_engine_group_infos_from_vllm(
    ...
    group_tokens_per_chunk: dict[int, int] = {}
    if vllm_groups:
        ...
        for engine_group_id, group in enumerate(vllm_groups):
            ...
            group_tokens_per_chunk[engine_group_id] = group.kv_cache_spec.block_size
    ...
    return [
        EngineGroupInfo(
            ...
            tokens_per_chunk=group_tokens_per_chunk.get(identity[4], 0),
        )
