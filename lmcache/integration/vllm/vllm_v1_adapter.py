...
class LMCacheConnectorV1Impl:
    ...
    def __init__(self, vllm_config: "VllmConfig", role: KVConnectorRole,
        ...
        if role == KVConnectorRole.SCHEDULER:
            ...
            # TODO support enabling layerwise load/save independently?
            if self.do_async_save and self.use_layerwise:
                logger.warning(
                    "Probably best to not use async save with layerwise save")
