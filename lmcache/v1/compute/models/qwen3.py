...
class LMCQwen3Model(nn.Module):
    def __init__(
        ...
        # remove hard code - Qwen3 specific rotary embedding setup
    ...
    def compute_layer(
        ...
        for idx, layer in enumerate(
            ...
            # Note: For Qwen3, q_norm and k_norm will be applied in the blender's
            # process_qkv method after rotary embedding, so we don't apply them here
