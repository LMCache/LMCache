...
class QStoreModule(InstanceLivenessTarget):
    ...
    def handle_register_q_cache(
        ...
        """Handle a transport-neutral Q-cache registration."""
    ...
    def handle_unregister_q_cache(
        ...
        """Handle a transport-neutral Q-cache removal."""
        self.unregister_q_cache(request.instance_id)
    ...
    def handle_store_q(self, request: StoreRequest) -> StoreResponse:
        """Handle a transport-neutral Q-cache store request."""
        event_ipc_handle, success = self.store_q(
            request.key,
            request.instance_id,
