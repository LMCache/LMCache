...
def get_protocol_definitions() -> dict[str, ProtocolDefinition]:
    ...
    return {
        # Register KV Cache
        # Payload:
        #   - instance_id: int - Unique identifier for the GPU instance
        ...
        #   - engine_type: EngineType - Serving engine
        #   - layout_hints: LayoutHints - See LayoutHints in gpu_connector/utils.py.
        # Returns: None
