...
class HiddenStateStore:
    ...
    # ------------------------------------------------------------------
    # Internal allocation with HS-only LRU eviction
    # ------------------------------------------------------------------
    ...
    def store_hidden_states(
        ...
        *,
        ...
        Args:
            token_ids: 1-D int tensor or list of full token IDs (same
                sequence used for KV storage so chunk boundaries align).
            hidden_states: 2-D tensor of shape [len(token_ids), hidden_dim]
