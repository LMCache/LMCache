...
class LMCacheEngine:
    ...
    def retrieve_layer(
        ...
        **kwargs,
        ...
        # LocalCPUBackend returns the same objects pinned by lookup(pin=True);
        # lookup_unpin() owns those pins. Other backends may return temporary
        # pinned staging objects that must be released after the device-side
        # sync has been enqueued.
