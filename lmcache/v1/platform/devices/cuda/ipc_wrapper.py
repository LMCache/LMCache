...
:attr:`~lmcache.v1.platform.devices.cuda.CudaDeviceSpec.ipc_wrapper_cls`,
...
(``lmcache/v1/platform/devices/cuda/vmm_ipc.py``). The multiprocess adapter
dispatches through
...
from lmcache.v1.platform.devices.cuda.utils import (
    _cuda,
...
class VmmCudaIPCWrapper(DeviceIPCWrapper):
    ...
    ``docs/design/v1/platform/devices/cuda/vmm_cuda_ipc.md``.
    """
