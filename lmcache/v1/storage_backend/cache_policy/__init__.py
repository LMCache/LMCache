...
from lmcache.v1.storage_backend.cache_policy.s3fifo import S3FIFOCachePolicy
...
def get_cache_policy(policy_name: str) -> BaseCachePolicy:
    ...
    """
    supported_policies = ["LRU", "LFU", "FIFO", "S3-FIFO"]
    if policy_name == "LRU":
    ...
    elif policy_name == "S3-FIFO":
        return S3FIFOCachePolicy()
    else:
        raise ValueError(
