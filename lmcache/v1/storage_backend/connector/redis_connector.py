...
# see examples/kv_cache_reuse/remote_backends/resp/example_resp_client.py
# for usage/benchmarking
class RESPClient:
    def __init__(
        self,
        host: str,
...
class RESPConnector(RemoteConnector):
    ...
    def __init__(
        ...
        # this gives us access to self.full_chunk_bytes
        ...
        self.client = RESPClient(host, port, self.full_chunk_bytes, num_threads, loop)
