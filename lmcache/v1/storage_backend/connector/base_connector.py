...
class RemoteConnector(metaclass=abc.ABCMeta):
    ...
    def __init__(
        ...
        - `full_chunk_bytes` is the size of the lmcache full chunk.
        ...
        self.full_chunk_bytes: int = get_size_bytes(self.meta_shapes, self.meta_dtypes)
        assert self.full_chunk_bytes % metadata.chunk_size == 0
        self.single_token_size = self.full_chunk_bytes // metadata.chunk_size
