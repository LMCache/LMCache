...
class DummyLocalCpuBackend(LocalCPUBackend):
    """Dummy implementation for scheduler role that does nothing"""

    def __init__(self, config: LMCacheEngineConfig):
        # super().__init__(config, dst_device="cpu")
        pass
    ...
    def initialize_allocator(
        ...
        # Return a dummy allocator that doesn't actually allocate
        return MixedMemoryAllocator(0)
