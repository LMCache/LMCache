...
For event metadata contracts, see [EVENTS.md](EVENTS.md).
For design rationale, see [event-bus.md](event-bus.md).
For the trace recording subsystem (`lmcache trace`), see [trace.md](trace.md).
