...
def _create_config_class():
    ...
    cls = make_dataclass(
        ...
        namespace={
            ...
            "get_mla_lookup_server_worker_ids": _get_mla_lookup_server_worker_ids,
...
def _get_mla_lookup_server_worker_ids(self, use_mla, world_size):
    if self.mla_lookup_server_worker_ids is None:
    ...
    # check the input
    for worker_id in self.mla_lookup_server_worker_ids:
        assert -1 < worker_id < world_size
    return self.mla_lookup_server_worker_ids
