...
class ServerBenchClient:
    ...
    def __init__(
        ...
        self._config = config
        self._log = log
        self._client: "MultiprocessGrpcClient | None" = None
    ...
    def close(self) -> None:
        ...
        if self._client is not None:
            try:
                ...
                self._log("  [warning] MultiprocessGrpcClient close failed: %s" % exc)
            finally:
                self._client = None
    ...
    def _initialize(self) -> None:
        ...
        self._client = MultiprocessGrpcClient(config.rpc_url)
    ...
    def _require_started(self) -> "MultiprocessGrpcClient":
        """Return the live gRPC client or raise before startup."""
