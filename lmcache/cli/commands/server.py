    ...
    def add_arguments(self, parser: argparse.ArgumentParser) -> None:
        ...
        try:
            ...
            native_group.add_argument(
                "--native",
                action="store_true",
                help=("Launch the CUDA-enabled native C++ MP server when available."),
            )
            native_group.add_argument(
                "--native-cuda",
                action="store_true",
                help=(
                    "Launch the CUDA-enabled native C++ MP server build. This "
                    "is the default native mode and implies --native."
                ),
            )
            native_group.add_argument(
                "--native-no-cuda",
