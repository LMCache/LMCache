...
from lmcache.experimental.protocol import ClientMetaMessage, Constants, ServerMetaMessage
...
class LMCServerConnector(RemoteConnector):
    ...
    def exists(self, key: CacheEngineKey) -> bool:
        ...
        self.client_socket.sendall(
            ClientMetaMessage(
                Constants.CLIENT_EXIST, key, 0,
                MemoryFormat(1), torch.float16, torch.Size([0, 0, 0])
                ).serialize())
