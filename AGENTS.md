...
- LMCache mainly serves distributed LLM inference. Make sure to handle edge cases and make the code robust. Make sure thread safety is maintained for shared data structures. Make sure CUDA/GPU resources are properly managed (allocated, freed, synchronized).
