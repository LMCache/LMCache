...
file_paths_ours = ['results/Apr_14/context_based/01_processed.csv', 'results/Apr_14/context_based/10_processed.csv', 'results/Apr_14/context_based/100_processed.csv']
