...
func (in *PDSpec) DeepCopyInto(out *PDSpec) {
	*out = *in
	if in.NixlSideChannelPort != nil {
		in, out := &in.NixlSideChannelPort, &out.NixlSideChannelPort
		*out = new(int32)
		**out = **in
	}
	if in.NixlLoadFailurePolicy != nil {
		in, out := &in.NixlLoadFailurePolicy, &out.NixlLoadFailurePolicy
		*out = new(string)
		**out = **in
	}
	if in.EnforceHandshakeCompat != nil {
		in, out := &in.EnforceHandshakeCompat, &out.EnforceHandshakeCompat
		*out = new(bool)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RouterEndpointSpec) DeepCopyInto(out *RouterEndpointSpec) {
	*out = *in
	if in.Port != nil {
		in, out := &in.Port, &out.Port
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RouterEndpointSpec.
func (in *RouterEndpointSpec) DeepCopy() *RouterEndpointSpec {
	if in == nil {
		return nil
	}
	out := new(RouterEndpointSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VllmRouterSpec) DeepCopyInto(out *VllmRouterSpec) {
	*out = *in
	...
	if in.IntraNodeDataParallelSize != nil {
		in, out := &in.IntraNodeDataParallelSize, &out.IntraNodeDataParallelSize
		*out = new(int32)
		**out = **in
	}
