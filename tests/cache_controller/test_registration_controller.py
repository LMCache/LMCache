...
# First Party
from lmcache.cache_controller.controllers.registration_controller import (
...
class TestRegistrationControllerRegister:
    ...
    async def test_register_new_worker(self, reg_controller, mock_zmq_socket):
        ...
        with patch(
            "lmcache.cache_controller.controllers.registration_controller.get_zmq_socket"
        ) as mock_get_socket:
...
class TestRegistrationControllerMetrics:
    ...
    @patch(
        "lmcache.cache_controller.controllers.registration_controller.PrometheusLogger"
    )
