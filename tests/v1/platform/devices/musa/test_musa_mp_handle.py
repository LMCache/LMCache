...
def test_musa_handle_transfer_disabled_by_default(
    ...
    # First Party
    from lmcache.v1.platform.devices.musa import ipc_wrapper
...
def test_musa_platform_discovers_factory_and_registers_capability_predicate() -> None:
    ...
    import lmcache.v1.platform.devices.musa as musa_platform
...
def test_musa_ipc_wrapper_rejects_non_musa_tensor() -> None:
    ...
    # First Party
    from lmcache.v1.platform.devices.musa.ipc_wrapper import MusaIPCWrapper
