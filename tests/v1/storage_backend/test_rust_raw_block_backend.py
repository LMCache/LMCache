...
def test_rust_raw_block_backend_v2_incremental_multi_key_recovery(
    memory_allocator, loop_in_thread
):
    """End-to-end: v2 incremental checkpoint recovers multi-key state with
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        base_cfg = LMCacheEngineConfig.from_defaults(
            ...
            local_cpu=True,
            max_local_cpu_size=0.1,
            lmcache_instance_id="test_rust_raw_block_v2_multi_key_recovery",
        )
        base_cfg.extra_config = {
            "rust_raw_block.device_path": dev_path,
            "rust_raw_block.block_align": 4096,
        ...
        # Sanity: the v2 layout took effect (delta region carved out).
        assert backend1._core._use_incremental is True
        assert backend1._core._meta_layout.delta_region_bytes > 0
