...
def worker_with_transfer_context(
    ...
    monkeypatch.setattr(atom_adapter, "MultiprocessGrpcClient", lambda *args: client)
...
def _resolved_future(value: Any) -> MessagingFuture[Any]:
    """Return a completed future with ``value``."""
...
def _mock_client(worker: AtomMPWorkerAdapter) -> MagicMock:
    """Expose the fixture-provided gRPC client mock with assertion helpers."""
