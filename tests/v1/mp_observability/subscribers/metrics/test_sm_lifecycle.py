...
- ``lmcache_mp.real_reuse_gap_volume`` — per-``cache_salt`` chunk-event
...
class TestReadEmitsGap:
    def test_read_then_read_records_gap(self, bus, subscriber):
        ...
        before_c = _totals_by_salt("lmcache_mp.real_reuse_gap_volume")
        ...
        chunks_d = _delta(before_c, _totals_by_salt("lmcache_mp.real_reuse_gap_volume"))
    ...
    def test_write_then_read_records_gap(self, bus, subscriber):
        ...
        before = _totals_by_salt("lmcache_mp.real_reuse_gap_volume")
        ...
        delta = _delta(before, _totals_by_salt("lmcache_mp.real_reuse_gap_volume"))
    ...
    def test_first_access_is_cold_no_emission(self, bus, subscriber):
        ...
        c_d = _delta(before_c, _totals_by_salt("lmcache_mp.real_reuse_gap_volume"))
