...
def mock_remote_backend(event_loop_thread, test_config, controllable_connector):
    ...
    backend.get_interval_get_blocking_failed_count.return_value = 0
    return backend
...
class TestRemoteBackendHealthCheckFallbackRecovery:
    ...
    def test_multiple_backends_fallback_and_partial_recovery(
        ...
        backend_a.get_interval_get_blocking_failed_count.return_value = 0
        ...
        backend_b.get_interval_get_blocking_failed_count.return_value = 0
