...
def dumb_metadata(fmt="vllm", kv_shape=(32, 2, 256, 8, 128), kv_dtype=torch.bfloat16):
    return LMCacheEngineMetadata(kv_shape, kv_dtype)

@pytest.mark.parametrize("mem_pool_type", [LocalCPUBufferPool, LocalCPUPool, LocalGPUPool])
