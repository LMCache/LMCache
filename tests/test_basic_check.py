...
# First Party
from lmcache.basic_check import main, parse_args
from lmcache.check import CheckModeRegistry, check_mode
...
class TestMain:
    ...
    async def test_list_mode(self, monkeypatch, capsys) -> None:
        ...
        monkeypatch.setattr("lmcache.basic_check.registry", fake_reg)
