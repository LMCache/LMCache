...
def _load_library(path: Path | None = None) -> ctypes.CDLL:
    ...
    lib.lmcache_mp_cpp_blake3_chunk_hashes.argtypes = [
        ctypes.POINTER(ctypes.c_uint32),
        ctypes.c_uint64,
        ctypes.c_uint64,
        ctypes.c_uint64,
    ...
    lib.lmcache_mp_cpp_blake3_chunk_hashes.restype = ctypes.c_int
...
class TieredCache:
    ...
    def last_error(self) -> str:
        raw = self._lib.lmcache_mp_cpp_cache_last_error(self._ptr)
