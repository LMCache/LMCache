...
def demonstrate_basic_allocation():
    ...
    try:
        ...
        print(
            f"   Successfully allocated {tensor1.meta.shape} and {tensor2.meta.shape}"
        )
...
def monitor_hugepage_usage():
    ...
    try:
        ...
        total_gb = available_count * hugepage_size / (1024 * 1024 * 1024)
        print(f"   Total available memory: {total_gb:.2f} GB")
