...
> `LMCacheConnectorV1`, or `lmcache_server` are retained for legacy in-process
> deployments. Prefer MP for new deployments; see the [migration guide](https://docs.lmcache.ai/legacy/migration_to_mp.html).
