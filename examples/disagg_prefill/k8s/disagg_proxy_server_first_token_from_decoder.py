...
async def lifespan(app: FastAPI):
    ...
    # Parse comma-separated prefiller hosts
    prefiller_hosts = [host.strip() for host in global_args.prefiller_host.split(",")]
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="localhost",
        help="Comma-separated list of prefiller hosts (e.g., 'host1,host2,host3')",
    )
...
async def handle_completions(request: Request):
    ...
    try:
        ...
        async def generate_stream():
            # ToDo: will pick specific decoder when xPyD
