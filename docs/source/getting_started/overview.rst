...
**LMCache Connector**
   ...
   * **Cache miss**: Model computes KV as usual, then Connector hands new KV data to LMCache for storage
...
**Asynchronous Offloading**
   Performs heavy data movement asynchronously to avoid blocking inference threads. Spawns async "put" tasks to offload KV tensors to configured backends in the background, enabling pipelined workflow: Compute KV → Use for generation → Asynchronously write out.
