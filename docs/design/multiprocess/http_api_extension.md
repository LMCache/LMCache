...
Located at `lmcache/multiprocess/http_api_registry.py`.
...
Located at `lmcache/multiprocess/http_apis/`.
...
Create a new file in `lmcache/multiprocess/http_apis/` with the
...
1. Be placed in `lmcache/multiprocess/http_apis/`.
