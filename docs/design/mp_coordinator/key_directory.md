...
Module: `lmcache/mp_coordinator/key_directory.py`
Contract vocabulary: `lmcache/mp_coordinator/api.py`
HTTP surface: `lmcache/mp_coordinator/http_apis/directory_api.py` (`/directory/*`)
