...
sed -i "s|blend_special_str: .*|blend_special_str: \"$BLEND_SPECIAL_STR\"|g" lmcache_blend_gpu_2.yml
...
for ratio in "${blend_recompute_ratios[@]}"; do
  ...
  sed -i "s|blend_recompute_ratios: .*|blend_recompute_ratios: ${ratio}|g" lmcache_blend_gpu_2.yml
